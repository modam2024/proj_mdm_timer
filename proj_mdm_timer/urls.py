...
urlpatterns = [
    ...
    path('article/timer-start/', article_views_test.timer_start, name='feedback_english'),
    path('article/timer-stop/', article_views_test.timer_stop, name='feedback_english'),
